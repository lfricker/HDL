...
add wave -noupdate /tb_Toplevel_C5G_GPIO/dut/prescaler_50m_1m/rst_n
...
add wave -noupdate -format Analog-Step -height 74 -max 254.0 -radix unsigned /tb_Toplevel_C5G_GPIO/dut/speed
...
WaveRestoreCursors {{Cursor 1} {1659090000 ps} 0} {{Cursor 2} {4830090000 ps} 0}
...
update
WaveRestoreZoom {0 ps} {11419905 ns}
